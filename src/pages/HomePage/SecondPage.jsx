...
const SecondPage = () => {
  return (
    <div className="px-10 py-16 text-center bg-white ">
      {/* Title Section */}
      <h2 className="text-2xl md:text-4xl font-bold mb-4 p-8">
        Unlock Your <span className="text-blue-600">Networking Potential</span> with Network_Next
      </h2>
      <p className="text-md md:text-lg text-gray-600 max-w-3xl mx-auto mb-12">
        Join our vibrant community on Trade Gospel, where you can watch and participate in live trading sessions. 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold mb-2">Jobs & Referral</h3>
          <p className="text-gray-600">
