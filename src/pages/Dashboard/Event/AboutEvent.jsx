  ...
  return (
    <div className="flex justify-center p-8 overflow-auto hide-scrollbar">
      ...
      <div className="bg-white shadow-lg rounded-lg max-w-6xl w-full p-6 overflow-auto hide-scrollbar">
        {/* Event Image */}
        <img src={eventphoto} className="w-full h-[300px] object-cover rounded-lg" />
        
        {/* Event Date and Time */}
        <p className="mt-2 text-gray-500">{new Date(date).toLocaleDateString()} {time}</p>
        ...
        <div className="mt-6">
          ...
          <p className="text-sm text-gray-600">Total Attending: {attending?.length || 0}</p>
        </div>
